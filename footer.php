  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 text-center">
        ...
        <h5 class="footer-header">Minha conta</h5>
        <p>Lorem ipsum<br>
        Lorem ipsum<br>
        Lorem ipsum<br>
        Lorem ipsum<br>
      ...
      <div class="col-lg-4 text-center">
       ...
       <h5 class="footer-header">Comprar</h5>
...
<div class="footer1">
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        <p>Termos de pesquisa no mapa do site Pesquisa avançada Pedidos e devoluções Contate-nos</p>
