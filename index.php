  ...
  <div class="row">
    <div class="col-md-6">
        ...
        <div class="banner-text">
          <p class="bt1">Bem-vindo ao</p>
          <p class="bt2"><span class="bt3">Moda</span>Loja</p>
    ...
    <div class="topsell-head">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>Uma passagem de Lorem Ipsum que você precisa aqui</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-sm-12">
        <span class="welcometitle">Bem-vindo ao Advogados Pro</span>
        ...
        <div class="row" id="wel1">
          ...
          <h6 class="wh">Suporte on-line gratuito 24 horas por dia, 7 dias por semana</h6>
            <p class="wp">Existem muitas variações de passagens de Lorem Ipsum disponíveis<br>
            mas são muitas variações </p>
          </div>   
        </div>
