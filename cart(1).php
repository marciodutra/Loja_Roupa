  ...
  <?php
   $total=0;
    ...
    <tr>
      ...
      <td><a href="cart(1).php?remove=<?php echo $row['id']; ?>">remover</a></td>
    </tr>
    <?php 
    }
...
<tbody>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <h5>Se for dinheiro na entrega, coloque 0 no campo bkash</h5>
      ...
      <input type="hidden" name="user_name" value="<?php echo $_SESSION['username']; ?>">
       ...
       <div class="input-group form-group">
        <input type="number" class="form-control" placeholder="Telefone" name="number">
       </div>
       <div class="input-group form-group">
        <input type="number" class="form-control" placeholder="" name="mobnumber">
       </div>
       <div class="input-group form-group">
        <input type="text" class="form-control" placeholder="Taxa" name="txid">
       </div>

      <div class="form-group">
      <input type="submit" value="Peça agora" name="order_btn">
    </div>
